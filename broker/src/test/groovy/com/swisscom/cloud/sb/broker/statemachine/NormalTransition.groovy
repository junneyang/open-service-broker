...
@CompileStatic
class NormalTransition extends BaseTransition<TestStateMachineContext> {

    private final int retryDelay

    protected NormalTransition(String name, Integer retryDelay = 0) {
        super(name)
    ...
    Boolean canTransitionInternal(TestStateMachineContext context) {
        return context.getRetryCount() >= retryDelay
    }
